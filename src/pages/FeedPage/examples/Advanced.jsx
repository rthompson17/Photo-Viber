...
//           // try to access each photoUrl from postsApi.js to display the image in the Tinder Card
//           <TinderCard
//             // ref={childRefs[index]}
//             // className='swipe'
//             // key={post.username}
//             // onSwipe={(dir) => swiped(dir, post.username, index)}
//             // onCardLeftScreen={() => outOfFrame(post.username, index)}
//           >
//             <div
